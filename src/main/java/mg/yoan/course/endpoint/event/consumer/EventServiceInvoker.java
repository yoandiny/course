package mg.yoan.course.endpoint.event.consumer;
...
import mg.yoan.course.endpoint.event.consumer.model.TypedEvent;
...
public class EventServiceInvoker implements Consumer<TypedEvent> {
  ...
  public void accept(TypedEvent typedEvent) {
    ...
    var eventClasses = getAllClasses("mg.yoan.course.endpoint.event.model");
  ...
  private String getEventService(String eventClazzName) {
    ...
    return "mg.yoan.course.service.event."
